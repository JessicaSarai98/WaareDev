...
namespace DataAccess
{
    public class CD_Conexion
    {
        ...
        // karina
        private SqlConnection Conexion = new SqlConnection(@"Data Source = (LocalDB)\MSSQLLocalDB; Initial Catalog = C:\Users\William carmona\Documents\users.mdf;Integrated Security = True; Connect Timeout = 30");
